...
class PlanchetaCatastral extends Component{
          ...
          <div className="panel panel-info" style={{'borderColor': '#bce8f1'}}>
                  ...
                  <div className='row'>
                    <div className='col-lg-12'>
                      <img src='http://geomatica.com.ar/chacabuco/plancheta.png' width="100%" />
                    </div>
                  </div>
        		    </div>
      	  </div>
...
export default connect(mapStateToProps, null)(PlanchetaCatastral);