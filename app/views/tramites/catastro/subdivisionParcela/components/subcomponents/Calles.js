...
import CallesArray from './CallesArray';
      ...
      <div className="col-lg-12">
        <div className="panel panel-info" style={{'borderColor': '#bce8f1'}}>
          ...
          <div className="panel-body">
              <div className='col-lg-12'>
                <CallesArray calles={calles} id={this.props.id}/>
              </div>
              <br />
          </div>
        </div>
...
export default withRouter(connect(mapStateToProps, {editCalle,getCalles})(Calles));